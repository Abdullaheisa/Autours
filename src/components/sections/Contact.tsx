...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-white w-full">
      ...
      {/* Right Image: Stretched from top to bottom, pushed to far right */}
      <motion.div
        initial={{ opacity: 0, x: 100 }}
        whileInView={{ opacity: 1, x: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 1, ease: "easeOut" }}
        className="absolute top-0 right-0 bottom-0 w-full lg:w-1/2 pointer-events-none hidden lg:block"
      >
        <img
