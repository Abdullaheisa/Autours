...
export default function TravelInfoSection({ travelInfo }: Props) {
  // Map icons dynamically with brand styling
  const icons = [
  ...
  return (
    <section className="py-14 bg-gradient-to-br from-white via-gray-50/50 to-white text-gray-900 relative overflow-hidden">
      {/* Background soft glowing lights for a clean look */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
          ...
          {/* Feature Image Wrapper with premium light shadow */}
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            {/* Dynamic Benefit Stack (Clean Compact Light Tiles) */}
