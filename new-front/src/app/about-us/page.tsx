  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-black font-sans overflow-x-hidden">
      ...
      <main className="flex-grow">
        ...
        {/* Hero Car Section - Enhanced visual impact but tighter to text, improved mobile clipping */}
        <section className="w-full bg-white relative -mt-6 sm:-mt-8 z-10 px-4 sm:px-6 mb-16 overflow-visible">
          <div className="max-w-7xl mx-auto flex justify-center">
             <motion.img
                ...
                className="w-full max-w-full sm:max-w-[1000px] h-auto object-contain select-none pointer-events-none drop-shadow-[0_20px_30px_rgba(0,0,0,0.15)] hover:scale-[1.02] transition-transform duration-700"
              />
          </div>
        </section>

        {/* ORIGINAL Why Choose Us Section - Fixed mobile slider alignment */}
        <section className="py-12 md:py-16 bg-white border-y border-gray-50">
          <div className="max-w-6xl mx-auto px-0 sm:px-6">
            ...
            {/* Changed justify-center to justify-start md:justify-center to prevent clipping first item */}
            <div className="flex flex-row justify-start md:justify-center items-center gap-6 sm:gap-8 md:gap-16 flex-nowrap w-full overflow-x-auto scrollbar-hide px-6 py-2 pb-6">
              {[
                ...
                <motion.div
                  ...
                  className="flex flex-col items-center text-center space-y-3 shrink-0 min-w-[90px] sm:min-w-[100px]"
                >
        ...
        <section className="py-20 sm:py-24 bg-white overflow-hidden">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
            ...
            >
              <div className="w-full sm:w-3/4 md:w-2/5 shrink-0 relative max-w-xs mx-auto md:max-w-none">
                <div className="aspect-[4/3] md:aspect-[4/3] rounded-2xl overflow-hidden relative z-10 shadow-lg bg-gray-100">
                   <img
                ...
                <div className="absolute -top-4 -left-4 w-16 h-16 md:w-24 md:h-24 bg-primary rounded-full mix-blend-multiply filter blur-xl opacity-60 animate-blob"></div>
                <div className="absolute -bottom-4 -right-4 w-16 h-16 md:w-24 md:h-24 bg-primary-300 rounded-full mix-blend-multiply filter blur-xl opacity-60 animate-blob animation-delay-2000"></div>
              </div>
            ...
            >
              <div className="w-full sm:w-3/4 md:w-2/5 shrink-0 relative max-w-xs mx-auto md:max-w-none">
                ...
                {/* Decorative background shapes */}
                <div className="absolute -top-4 -right-4 w-16 h-16 md:w-24 md:h-24 bg-gray-200 rounded-full mix-blend-multiply filter blur-xl opacity-60 animate-blob"></div>
                <div className="absolute -bottom-4 -left-4 w-16 h-16 md:w-24 md:h-24 bg-gray-300 rounded-full mix-blend-multiply filter blur-xl opacity-60 animate-blob animation-delay-2000"></div>
              </div>
              ...
              <div className="w-full md:w-3/5 space-y-3">
                ...
                <h2 className="text-2xl sm:text-3xl font-black text-black tracking-tight leading-tight mb-4 text-center md:text-left">
                ...
                <div className="space-y-1.5">
                  {[
                    ...
                    <div key={idx} className="flex items-start md:items-center gap-2.5 p-1.5 rounded-lg hover:bg-gray-50 transition-colors">
                      <div className="w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center shrink-0 mt-0.5 md:mt-0">
                        <svg className="w-3.5 h-3.5 text-primary-800" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                        </svg>
                      </div>
                      <p className="text-gray-700 text-sm font-medium leading-snug text-left">
                        {goal}
                      </p>
                    </div>
                  ))}
