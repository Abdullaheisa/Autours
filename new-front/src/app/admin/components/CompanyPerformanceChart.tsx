...
export default function CompanyPerformanceChart() {
  ...
  return (
    <div className="bg-white rounded-2xl p-4 sm:p-5 lg:p-6 border border-gray-200 shadow-sm">
      ...
      <div className="h-[220px] sm:h-[250px] lg:h-[260px] flex items-center justify-center">
        {data.length === 0 ? (
          <p className="text-sm text-gray-400">No company booking data available</p>
        ) : (
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie data={data} cx="50%" cy="45%" innerRadius={50} outerRadius={80} paddingAngle={4} dataKey="bookings" strokeWidth={0}>
