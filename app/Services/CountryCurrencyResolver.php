...
class CountryCurrencyResolver
{
    ...
    {
        $clean = strtolower(trim($countryName));
        ...
        return match ($clean) {
            'united arab emirates', 'uae', 'demo street' => 'AE',
            'bahrain' => 'BH',
            'egypt' => 'EG',
            'jordan' => 'JO',
            'kuwait' => 'KW',
            ...
            'slovakia' => 'SK',
            'sint maarten' => 'SX',
            'turkey', 'türkiye', 'turkiye', 'gaziemir' => 'TR',
            'ukraine' => 'UA',
            'kosovo' => 'XK',
            'argentina' => 'AR',
            'chile' => 'CL',
            ...
            'puerto rico' => 'PR',
            'curacao', 'curaçao' => 'CW',
            'united states', 'usa', 'united states of america', 'california', 'florida', 'nevada', 'texas', 'new york', 'illinois', 'hawaii', 'washington', 'arizona', 'colorado', 'massachusetts', 'michigan', 'new jersey', 'north carolina', 'ohio', 'pennsylvania', 'tennessee', 'virginia', 'utah' => 'US',
            'uruguay' => 'UY',
