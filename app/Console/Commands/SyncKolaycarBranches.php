...
class SyncKolaycarBranches extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'kolaycar:sync-branches {--dry-run : Only fetch from API and print what would be done} {--real : Perform the actual synchronization to the database}';
     ...
     * @var string
     */
    protected $description = 'Sync Kolaycar (Arscar) locations as branches.';
    ...
    public function handle(): int
    {
        ...
        // ------------------------------------------------------------------
        // 1. Resolve or create the Kolaycar (Arscar) supplier user
        // ------------------------------------------------------------------
        ...
        // ------------------------------------------------------------------
        // 2. Fetch all locations from Kolaycar
        // ------------------------------------------------------------------
        $this->info('Fetching locations from Kolaycar...');
