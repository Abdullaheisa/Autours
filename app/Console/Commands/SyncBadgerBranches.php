...
class SyncBadgerBranches extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'badger:sync-branches {--dry-run : Only fetch from API and print what would be done} {--real : Perform the actual synchronization to the database}';
     ...
     * @var string
     */
    protected $description = 'Sync Badger locations as branches.';
    ...
    public function handle(): int
    {
        ...
        // ------------------------------------------------------------------
        // 1. Resolve or create the Badger supplier user
        // ------------------------------------------------------------------
        ...
        // ------------------------------------------------------------------
        $this->info('Fetching locations from Badger...');
