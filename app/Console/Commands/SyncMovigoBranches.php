...
class SyncMovigoBranches extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'movigo:sync-branches {--dry-run : Only fetch from API and print what would be done} {--real : Perform the actual synchronization to the database}';
     ...
     * @var string
     */
    protected $description = 'Sync Movigo locations as branches.';
    ...
    public function handle(): int
    {
        ...
        $service = new KolaycarApiService('rBBj07xzP9Fd8pSAFIdjbQ==', 'MolC.!8695gF1');

        // ------------------------------------------------------------------
        // 1. Resolve or create the Movigo supplier user
        // ------------------------------------------------------------------
        ...
        // ------------------------------------------------------------------
        $this->info('Fetching locations from Movigo...');
